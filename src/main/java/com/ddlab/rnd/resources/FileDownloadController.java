...
public class FileDownloadController {
	...
	public Response downloadFileWithPost(@Parameter(style = ParameterStyle.FORM, 
											description = "File name", required = true, name = "id", 
											schema = @Schema(implementation = String.class))
										 @FormParam("file") String file) {
		String path = "E:/sure-delete";
	...
	@Path("/image/download")
	@Produces(MediaType.APPLICATION_OCTET_STREAM)
	public Response downloadFileWithGet(@Parameter(description = "File name", required = true)
	...
	@Produces("image/jpg")
	public Response getImageAsResponseEntity(@Parameter(description = "File name", required = true)
